...
int tableCartes[4][8];
int b[3];
int receivedDataTable[3]; // ajouté par moi
char finalMessage[64]; // ajouté par moi
int goEnabled;
int connectEnabled;
...
int main(int argc, char ** argv)
{
    ...
    char winname[64];
    sprintf(winname, "SDL2 SH13 : %s", gName);
    SDL_Window * window = SDL_CreateWindow(winname,
	...
	deck[0] = IMG_Load("imgs/SH13_0.png");
	deck[1] = IMG_Load("imgs/SH13_1.png");
	deck[2] = IMG_Load("imgs/SH13_2.png");
	deck[3] = IMG_Load("imgs/SH13_3.png");
	deck[4] = IMG_Load("imgs/SH13_4.png");
	deck[5] = IMG_Load("imgs/SH13_5.png");
	deck[6] = IMG_Load("imgs/SH13_6.png");
	deck[7] = IMG_Load("imgs/SH13_7.png");
	deck[8] = IMG_Load("imgs/SH13_8.png");
	deck[9] = IMG_Load("imgs/SH13_9.png");
	deck[10] = IMG_Load("imgs/SH13_10.png");
	deck[11] = IMG_Load("imgs/SH13_11.png");
	deck[12] = IMG_Load("imgs/SH13_12.png");

	objet[0] = IMG_Load("imgs/SH13_pipe_120x120.png");
	objet[1] = IMG_Load("imgs/SH13_ampoule_120x120.png");
	objet[2] = IMG_Load("imgs/SH13_poing_120x120.png");
	objet[3] = IMG_Load("imgs/SH13_couronne_120x120.png");
	objet[4] = IMG_Load("imgs/SH13_carnet_120x120.png");
	objet[5] = IMG_Load("imgs/SH13_collier_120x120.png");
	objet[6] = IMG_Load("imgs/SH13_oeil_120x120.png");
	objet[7] = IMG_Load("imgs/SH13_crane_120x120.png");

	gobutton = IMG_Load("imgs/gobutton.png");
	connectbutton = IMG_Load("imgs/connectbutton.png");
   ...
   ret = pthread_create ( & thread_serveur_tcp_id, NULL, fn_serveur_tcp, NULL);
    ...
    int w = 0;
        ...
        while (token != NULL){
          if (w > 0){
            receivedDataTable[w-1] = atoi(token);
          }
          token = strtok(NULL, " \n");
          w++;
        }

        if (tableCartes[receivedDataTable[0]][receivedDataTable[1]] == -1 ||
          tableCartes[receivedDataTable[0]][receivedDataTable[1]] == 100){
          tableCartes[receivedDataTable[0]][receivedDataTable[1]] = receivedDataTable[2];
        }

				break;

      // Message 'Z' : fin du jeu
      case 'Z':
        while (token != NULL){
          if (w > 0){
            receivedDataTable[w-1] = atoi(token);
        ...
        sprintf(finalMessage, "%d a gagné la partie!", receivedDataTable[0]);
        SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_INFORMATION, "Fin du jeu", finalMessage, NULL);
        break;
		}
		synchro=0;
        }
